    ...
    <div className="space-y-4 sm:space-y-6">
      ...
      <Card className="border-border bg-card">
        ...
        <CardContent className="space-y-3 sm:space-y-4 p-4 sm:p-6 pt-0">
          ...
          <div className="bg-emerald-50 dark:bg-emerald-950/20 border border-emerald-200 dark:border-emerald-800 rounded-lg p-3 sm:p-4 mt-3 sm:mt-4">
      ...
      <div className="grid sm:grid-cols-2 gap-3 sm:gap-4">
        <Card className="border-emerald-200 dark:border-emerald-800 bg-emerald-50/50 dark:bg-emerald-950/20">
          <CardHeader className="pb-2 sm:pb-3 p-4 sm:p-6">
            <CardTitle className="flex items-center gap-2 text-emerald-700 dark:text-emerald-400 text-sm sm:text-base">
        ...
        <Card className="border-red-200 dark:border-red-800 bg-red-50/50 dark:bg-red-950/20">
          <CardHeader className="pb-2 sm:pb-3 p-4 sm:p-6">
            <CardTitle className="flex items-center gap-2 text-red-700 dark:text-red-400 text-sm sm:text-base">
            ...
            <Table className="text-xs sm:text-sm">
              ...
              <TableBody>
                {[
                  ...
                  <TableRow key={i} className={i === 6 ? 'bg-emerald-50 dark:bg-emerald-950/30' : 'hover:bg-muted/30'}>
