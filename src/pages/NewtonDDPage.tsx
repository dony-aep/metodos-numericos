...
import {
  ...
  NewtonDDPlots,
  NewtonDDTables,
} from '@/components/topics/newton-dd/NewtonDDResults';
    ...
    return [
      {
        ...
        content: (
            <div className="space-y-6">
              ...
              <NewtonDDReadout result={result} points={parsedPoints} />
            </div>
          ),
      },
      {
        label: 'Traza',
        note: 'El polinomio construido término a término.',
        content: <NewtonDDPlots result={result} points={parsedPoints} />,
      },
      {
        label: 'Tablas',
        note: 'Cada diagonal de la tabla aporta un coeficiente.',
        content: <NewtonDDTables result={result} points={parsedPoints} />,
      },
    ];
  }, [result, parsedPoints]);
