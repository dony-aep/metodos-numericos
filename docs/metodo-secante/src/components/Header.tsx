...
export function Header() {
  return (
    <header className="relative overflow-hidden bg-gradient-to-br from-slate-50 via-white to-amber-50/30">
      {/* Subtle grid pattern */}
      <div 
      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6 py-10 sm:py-16 md:py-20">
        <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-6 lg:gap-8">
          ...
          <div className="space-y-3 sm:space-y-4">
            ...
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-slate-800 tracking-tight">
              Método de la
          ...
          <div className="w-full sm:w-auto">
            <div className="bg-white/80 backdrop-blur border border-slate-200 rounded-xl sm:rounded-2xl p-3 sm:p-4 md:p-6 shadow-xl shadow-slate-200/50">
              ...
              <div className="text-slate-700 text-sm md:text-base overflow-x-auto">
